...
<template>
  <n-layout-header bordered class="the-header" style="display: flex; align-items: center;">
    ...
    <n-grid cols="24" item-responsive>
      ...
      <n-grid-item class="e" :span="linkSize" offset='2'>
        <router-link to="/">首页</router-link>
      </n-grid-item>

      <!-- 篡改检测 -->
      <n-grid-item class="a" :span="linkSize" offset='2'>
        <router-link to="/ITDL">篡改检测</router-link>
      </n-grid-item>

      <n-grid-item class="a" :span="linkSize" offset='3'>
        <router-link to="/jcls">检测历史</router-link>
      </n-grid-item>
      
      <!-- 研究成果 -->
      <n-grid-item class="c" :span="linkSize" offset='3'>
        <router-link to="/xgjs">相关技术</router-link>
      </n-grid-item>
      <!-- 关于我们 -->
      <n-grid-item class="d" :span="linkSize" offset='2'>
