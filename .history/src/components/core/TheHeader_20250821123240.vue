...
<template>
  <n-layout-header bordered class="the-header" style="display: flex; align-items: center;">
    ...
    <n-grid cols="24" item-responsive>
      ...
      <n-grid-item class="d" :span="linkSize" :offset="offset" v-if="isLoggedIn">
      ...
      <n-grid-item class="e" :span="linkSize" :offset="offset" v-else>
        <router-link to="/auth/login">
          <img src="@/assets/head.png" class="headImg" style="max-width: 30%;">
        </router-link>
      </n-grid-item>
