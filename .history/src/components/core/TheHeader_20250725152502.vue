...
watch(isMobile, (val) => {
  logosize.value = val ? 0 : 12; // 手机端 80%，PC 端 30%
  linkSize.value = val ?4:2;
}, { immediate: true });
...
<template>
  <n-layout-header bordered class="the-header" style="display: flex; align-items: center;">
    ...
    <n-grid cols="24" item-responsive>
      <n-grid-item class="ui-logo" :span="logosize">
        <TextLogo />
      </n-grid-item>

      <n-grid-item class="e" :span="linkSize" offset='0'>
        <router-link to="/">首页</router-link>
      </n-grid-item>

      <!-- 篡改检测 -->
      <n-grid-item class="a" :span="linkSize" offset='0'>
      ...
      <!-- 研究成果 -->
      <n-grid-item class="c" :span="linkSize" offset='0'>
        <router-link to="/xgjs">相关技术</router-link>
      </n-grid-item>
      <!-- 关于我们 -->
      <n-grid-item class="d" :span="linkSize" offset='0'>
      ...
      <n-grid-item class="d" :span="2" offset='0'>
        ...
        <el-dropdown trigger="hover">
          ...
          <span class="el-dropdown-link" style=" border: 2px dashed blueviolet;; ">
            ...
            /> -->
            <img src="https://api.ixiaowai.cn/api/api.php"></img>
          </span>
