    ...
    <el-collapse v-model="activeName" accordion>
      ...
      <el-collapse-item title="JSON 结果" name="json" >
        ...
        <div class="jsonResult"> 
          <h3>{{   JSON.stringify(appStore.detectionResult , null, 2) }}</h3>
        </div>
      </el-collapse-item>
      ...
      <el-collapse-item name="result" title="检测结果" >
        ...
        <div style="padding: 14px">
          ...
          <el-skeleton-item variant="h3" style="width: 100%;height: 100%;" />
...
const changeImg = () => {
  setTimeout(() => {
    isProcessing.value = false; // 确保这里能执行
    console.log('isProcessing changed to false'); // 调试用
  }, 2000);
};
